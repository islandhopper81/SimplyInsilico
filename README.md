...
> **Important**: `NEXT_PUBLIC_` variables are baked into the build at compile time. If you update them in Vercel, you must trigger a redeploy for the changes to take effect. If this variable is missing, the contact form will silently fail.
